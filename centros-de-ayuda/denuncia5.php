...
<head>
  ...
  <title>Información de Denuncias | ¿Cómo hacer seguimiento a una denuncia?</title>
  ...
  <link href="../css/style-denuncia5.css" rel="stylesheet" />
  <!-- responsive style -->
      ...
      <section class="client_section px-lg-5">
            <div class=" d-lg-flex pt-lg-4 ">
              <div class="col-lg-9 mx-auto">
                <p class="text-justify"> Una vez que ha quedado registrada tu denuncia, el seguimiento de las denuncias, se puede realizar a través de llamadas telefónicas o asistencia personal ante la Oficina de Atención al Ciudadano. También, puedes dar seguimiento con el número de carpeta de investigación y, si lo solicitas, puedes hacerlo a través de un asesor jurídico victimal.</p>

                <p class="text-justify"> Recuerda que tienes derecho a estar informado sobre los avances y las decisiones que tome el ministerio público sobre tu caso y a oponerte a alguna decisión, si no te convence o te perjudica.</p>
