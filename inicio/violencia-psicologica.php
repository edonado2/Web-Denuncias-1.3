...
<head>
  ...
  <title>Tipos de Violencia | Violencia Psicológica</title>
  ...
  <link href="../css/style-violencia-psicologica.css" rel="stylesheet" />
  <!-- responsive style -->
    ...
    <section class="slider_section position-relative">
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-6 ">
            <img src="../images/image4.jpg" class="img-modifier" alt="...">
          </div>
        </div>
      </div>
    </section>
    ...
    <div >
      ...
      <section class="client_section px-lg-5">
        <div class=" d-lg-flex px-lg-5 pt-4">
          <div class="col-lg-9">
            <p class="text-justify"> Por violencia psicológica se comprende un conjunto de conductas o comportamientos destinados a ocasionar en otros algún tipo de sufrimiento emocional o psíquico, constituyendo actos de verdadera agresión psicológica.</p>
          <p class="text-justify"> Estos actos, intencionados o no, reducen a la víctima, vulneran su autoestima o la someten a escarnio, humillación u otras formas de sufrimiento no físico, es decir, sin llegar a lastimar el cuerpo de la víctima. De hacerse recurrente, la violencia psicológica puede devenir en el maltrato psicológico.</p>
        
          <p class="text-justify"> Este tipo de violencia puede ser:</p>
          <p class="mt-3 mb-4 text-justify"><span class="font-weight-bold">• Activa.</span> </Text>Por ejemplo, cuando una persona insulta, disminuye o agrede emocional y psicológicamente a otra.</p>

          <p class="mt-3 mb-4 text-justify"><span class="font-weight-bold">• Pasiva.</span> </Text>Por ejemplo, una persona le retira atención a la otra, especialmente cuando requiere de ella, o la somete a abandono emocional.</p>

          <div class="heading_container py-5">
            <h2>EFECTOS DEL ABUSO EMOCIONAL O VERBAL</h2>
        </div>

        <p class="mt-3 mb-4 text-justify">El impacto de la violencia psicológica puede variar de acuerdo a la frecuencia e intensidad de las agresiones y de las características individuales de la víctima. Dentro de las consecuencias más reportadas están:</p>

          <p class="mt-3 mb-4 text-justify">• Consumo muy frecuente de alcohol, tabaco y sustancias psicoactivas.</p>

          <p class="mt-3 mb-4 text-justify">• Sentimientos de tristeza, bajo estado de ánimo e ideación suicida.</p>

          <p class="mt-3 mb-4 text-justify">• Altos niveles de estrés, irritabilidad y frustración. </p>

          <p class="mt-3 mb-4 text-justify">• Baja autoestima y disminución en el valor propio.</p>

          <p class="mt-3 mb-4 text-justify">• Depresión y/o ansiedad.</p>

          <p class="mt-3 mb-4 text-justify">• Deterioro de las relaciones cercanas (amigos, familiares).</p>
