...
<head>
  ...
  <title>Tipos de Violencia | Violencia Física</title>
  ...
  <link href="../css/style-violencia-fisica.css" rel="stylesheet" />
  <!-- responsive style -->
    ...
    <section class="slider_section position-relative">
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-6 ">
            <img src="../images/image3.jpg" class="img-modifier" alt="...">
          </div>
        </div>
      </div>
    </section>
    ...
    <div >
      ...
      <section class="client_section px-lg-5">
        <div class=" d-lg-flex px-lg-5 pt-4">
          <div class="col-lg-9">
            <p class="text-justify"> La violencia física es aquella acción generada de manera voluntaria y que por lo mismo ocasiona daños no accidentales, utilizando la fuerza física o material (es decir, sirviéndose de objetos) y que tiene como fin fundamental generar un impacto directo en el cuerpo y consecuencias físicas tanto externas como internas.</p>
          <p class="text-justify"> La violencia física ocurre cuando una persona trasgrede el espacio corporal de la otra sin su consentimiento, ya sea sometiéndola a golpes, jalones o empujones, o bien encerrándola, provocándole lesiones físicas con algún tipo de objeto (letales o no), o forzándola a tener algún tipo de relaciones sexuales.</p>
        

          <div class="heading_container py-5">
              <h2>EJEMPLOS DE VIOLENCIA FÍSICA</h2>
          </div>
          <p class="text-justify"> Algunos ejemplos de violencia física pueden ser:</p>
          <p class="mt-3 mb-4 text-justify">• Golpizas, asaltos con armas de cuerpo a cuerpo, arrollamientos con vehículos o agresiones físicas de cualquier tipo.</p>
          <p class="mt-3 mb-4 text-justify"> •  Disparos con arma de fuego.</p>
          <p class="mt-3 mb-4 text-justify">• Violaciones (actos sexuales no consentidos), sin importar el sexo o la orientación sexual de tanto víctima como victimario.</p>
          <p class="mt-3 mb-4 text-justify">• Castigos físicos que infringen dolor, sufrimiento corporal o que causan malestares de salud.</p>

          <div class="heading_container py-5">
            <h2>CONSECUENCIAS DE VIOLENCIA FÍSICA</h2>
        </div>

        <p class="mt-3 mb-4 text-justify">• Incapacidad para trabajar.</p>

          <p class="mt-3 mb-4 text-justify">• Enfermedades causadas por dicha lesión.</p>

          <p class="mt-3 mb-4 text-justify">• Homicidios.</p>

          <p class="mt-3 mb-4 text-justify">• Suicidios.</p>

          <p class="mt-3 mb-4 text-justify">• Generación de pánico en la victima.</p>
